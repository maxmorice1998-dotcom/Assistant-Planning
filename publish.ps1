...
$notes="La fenetre principale adapte automatiquement sa hauteur a l ecran afin que la version et le build restent visibles. La configuration Dendreo repare aussi automatiquement le marqueur SDIS-BOT lorsqu il manque."
