...
$notes="Apres une connexion AGATT ou Dendreo confirmee, l'interface conserve les deux voyants verts. Le controle global inutile qui faisait alterner 'connexion a verifier' entre les deux services a ete retire."
