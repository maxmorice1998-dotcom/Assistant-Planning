...
$notes="Le helper de mise a jour est maintenant lance hors du Job Windows du processus Node. Il continue donc l extraction et le remplacement apres la fermeture de l application."
