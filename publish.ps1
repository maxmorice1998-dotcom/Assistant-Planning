...
$notes="Le reglage du repos compensatoire conserve maintenant les indicateurs verts de connexion. L'enregistrement ne relance plus un controle inutile des trois services."
