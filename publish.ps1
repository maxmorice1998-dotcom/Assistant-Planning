...
$notes="Une relance pendant une installation en cours se ferme automatiquement afin de laisser l'installateur terminer, sans second telechargement. Le verrou est rattache au vrai processus et tout verrou abandonne est supprime immediatement. Inclut le correctif du repos compensatoire de la v1.0.46."
