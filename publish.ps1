...
$notes="La mise a jour ne rollbacke plus en boucle lorsque Windows refuse seulement la reconfiguration de la tache de synchronisation automatique. La nouvelle version reste installee et l'avertissement est consigne dans le journal."
