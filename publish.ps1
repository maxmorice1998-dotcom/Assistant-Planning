...
$notes="Correction des mails multiples lors des synchronisations : les synchronisations manuelles et automatiques ne déclenchent plus les anciens rapports techniques en attente. Seul le récapitulatif de la synchronisation ou son alerte en cas de problème est envoyé. Les anciens rapports restent conservés localement. Suppression de la liste des créations et suppressions Dendreo dans les mails ; le récapitulatif des gardes, le calendrier et les avertissements de conflit sont conservés."
